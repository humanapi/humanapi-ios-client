...
{
    return [[HumanAPIClientMedicalNarrativeEntity alloc] initWithClient:self];
}
...
{
    return [[HumanAPIClientMedicalTimelineEntity alloc] initWithClient:self];
}

- (HumanAPIClientMedicalVitalsEntity *)medicalVitals
{
    return [[HumanAPIClientMedicalVitalsEntity alloc] initWithClient:self];
}
...
@implementation HumanAPIClientMedicalNarrativeEntity
- (instancetype)initWithClient:(HumanAPIClient *)client
{
    return [super initWithClient:client andMasterPath:@"medical/narratives"];
}
@end

// MedicalOrganization Entity
@implementation HumanAPIClientMedicalOrganizationEntity
- (instancetype)initWithClient:(HumanAPIClient *)client
{
...
@implementation HumanAPIClientMedicalTimelineEntity

- (instancetype)initWithClient:(HumanAPIClient *)client
{
    return [super initWithClient:client andMasterPath:@"medical/timeline"];
}
@end

// MedicalVitals Entity
@implementation HumanAPIClientMedicalVitalsEntity
- (instancetype)initWithClient:(HumanAPIClient *)client
{
    return [super initWithClient:client andMasterPath:@"medical/vitals"];
}
@end
